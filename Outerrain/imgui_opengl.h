...
// You can copy and use unmodified ImGui_OpenGL_* files in your project. See main.cpp for an example of using this.
// If you use this binding you'll need to call 4 functions: ImGui_OpenGLXXXX_Init(), ImGui_OpenGLXXXX_NewFrame(), ImGui::Render() and ImGui_OpenGLXXXX_Shutdown().
